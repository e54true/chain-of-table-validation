...
class ChatGPT_validation:
    ...
    def generate_plus_with_score(self, prompt, options=None, end_str=None):
        ...
        messages = [
            {
                "role": "system",
                "content": "Please evaluate the given table state and the selected operation. Respond with 'yes' or 'no' only at first, and briefly explain why.",
            },
            {"role": "user", "content": prompt},
        ]
        gpt_responses = None
